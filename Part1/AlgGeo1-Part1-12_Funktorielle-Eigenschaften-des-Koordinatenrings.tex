...
liefert eine Kategorienäquivalenz, der durch Einschränkung eine Äquivalenz
\[
...
für $X\subseteq\mathbb{A}^{n}$, $Y\subseteq\mathbb{A}^{n}$ existiert:
\[
...
Da nach Voraussetzung $A\cong k[T]/\mathfrak{A}$ für Radikalideal
