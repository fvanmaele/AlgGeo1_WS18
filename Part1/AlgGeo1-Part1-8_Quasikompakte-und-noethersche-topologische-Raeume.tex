...
\section{Quasikompakte und noethersche topologische Räume}\label{sec:quasikompakt-noethersch}
\begin{defn}\label{def:quasikompakt/noethersch}
...
\end{defn}
\begin{lem}\label{lem:eigenschaften-noethersch}
...
\end{enumerate}
\end{proof}
\begin{prop}\label{prop:algebraische-mengen-noethersch}
...
\end{proof}
\begin{cor}[Primärzerlegung]\label{cor:primaerzerlegung}
