...
\section{Affine algebraische Mengen}\label{sec:algebraische-mengen}
\begin{defn}\label{def:algebraische-mengen}
\mbox{}
\begin{itemize}
...
\end{itemize}
\end{defn}
\begin{example}\label{bsp:algebraische-mengen-dim1}
...
\end{example}
%
\begin{example}\label{bsp:algebraische-mengen-dim2}
