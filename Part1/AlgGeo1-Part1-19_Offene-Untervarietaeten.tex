...
\section{Offene Untervarietäten}\label{sec:offene-untervarietaeten}
...
\begin{lem}[orig. 41]\label{lem:basisoffene-teilmengen-sind-affin}
...
\end{claim*}
\end{proof}
\begin{prop}[orig. 42]\label{prop:offener-teilraum-praevarietaet}
...
Die kanonische Inklusion $U \xhookrightarrow{i} X$ ist sicher stetig. Für $f\in\mathcal{O}_{X}(V), V \subseteq X$ offen gilt mit dem Einschränkungsaxiom
\[
