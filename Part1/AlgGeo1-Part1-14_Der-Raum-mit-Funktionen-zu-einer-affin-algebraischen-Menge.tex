...
\end{lem}
\begin{proof}
Ohne Einschränkung der Allgemeinheit: $g_{1}=g_{2}=g$ (sonst Erweitern!)
...
zur irreduziblen affin algebraische Menge gehörige Raum von Funktionen.} 
\end{enumerate}
\begin{prop}[orig. 33]
...
\begin{rem}[orig. 34]
\begin{enumerate}
\item Im allgemeinen existierten für $f\in\mathcal{O}_{x}(U)$ \textbf{nicht}
...
Da $\mathcal{D}(f)$ Basis der Topologie, kann es höchstens einen
