...
\section{Der Raum mit Funktionen zu einer affin-algebraischen Menge}\label{sec:alg-mengen-raeume-mit-fkt}
...
$X$.
\end{defn}
\begin{lem}\label{lem:gleichheit-im-funktionenkoerper}
...
\end{proof}
\begin{defn}\label{def:alg-menge-als-raum-mit-fkt}
...
\end{enumerate}
\begin{prop}[orig. 33]\label{prop:fkt-auf-basis}
...
Da $f_{2}(x)\neq0$ folgt weiter $x\notin V(\mathfrak{a})$.
\end{proof}
\begin{rem}[orig. 34]\label{rem:globale-darstellung-von-fkt}
\mbox{}
\begin{enumerate}
