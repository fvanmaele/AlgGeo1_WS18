...
\section{Definition von Prävarietäten}\label{sec:def-praevarietaet}
\begin{defn}[orig. 37]\label{def:affine-varietaet}
...
\end{defn}
%
\begin{defn}[orig. 38]\label{def:praevarietaet}
