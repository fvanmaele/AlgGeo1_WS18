...
\end{defn}
\begin{prop}
\label{prop:charakterisierung-irreduzibel}Für einen topologischen Raum $X \neq \emptyset$ sind
äquivalent:
\begin{enumerate}
...
\end{proof}
\begin{defn}\label{def:irreduzible-komponente}
...
von $X$.
\end{defn}
\begin{rem}\label{rem:irreduzibel}
\mbox{}
\begin{enumerate}
