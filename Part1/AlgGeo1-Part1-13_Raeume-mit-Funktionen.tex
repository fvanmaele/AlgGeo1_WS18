...
\label{def:offene-unterraeume-von-funktionen}Für $(X,\mathcal{O}_{X})$
und $U\subset X$ offen bezeichne $(U,\mathcal{O}_{X|_{U}})$ den
Raum mit Funktionen gegeben durch den topologischen Raum $U$ mit
Funktionen $\mathcal{O}_{X|_{U}}(V):=\mathcal{O}_{X}(V)$ für $V\underset{\text{offen}}{\subset}U\subset X$.
\end{defn}
