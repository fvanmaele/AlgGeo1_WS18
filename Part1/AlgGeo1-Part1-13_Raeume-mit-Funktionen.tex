...
\section{Räume mit Funktionen}\label{sec:raeume-mit-funktionen}
...
\begin{defn}[offene Unterräume von Räumen mit Funktionen]\label{def:raeume-mit-fkt-offener-unterraum}
